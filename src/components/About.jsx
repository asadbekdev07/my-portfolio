...
const About = () => {
  return (
    <section className="container-custom text-white pt-[80px] pb-[80px] relative flex items-center justify-center">
      <div className="w-[70%]">
        <p className="text-5xl mb-2">
          I'm{" "}
          <span className="text-[#ff9633] text-6xl">Asadbek Botirqulov</span>
        </p>
        <p className="text-5xl mb-2">Frontend Developer</p>
        <button className="button-custom mr-4">Contact me</button>
        <a href="/Resume.pdf" download="Asadbek_Botirqulov_CV.pdf" aria-label="Download CV">
          <button className="button-custom">
            Download CV <FontAwesomeIcon icon={faDownload} />
          </button>
        </a>
      </div>
      <div className="flex flex-col items-center absolute top-48 right-0">
